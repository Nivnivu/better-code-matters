...
const CommentsForm = ({ slug }) => {
  ...
  <div className="grid grid-cols-1 gap-4 mb-4">
    <div>
      ...
      <label className="text-gray-500 cursor-pointer ml-2" htmlFor="storeData">Save my e-mail and name.</label>
    </div>
  </div>
      {error && <p className="text-xs text-red-500">All fields are requierd.</p>}
      <div className="mt-8">
        <button type="button"
